      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-10">
          ...
          >
            ...
            <div>
              <div className="flex items-center gap-2 mb-1">
                <span className="text-slate-100 font-semibold text-sm">Industry Trend Bulletin</span>
              </div>
              <p className="text-slate-500 text-xs leading-relaxed">AI, digital transformation, and enterprise tech stories — refreshed daily.</p>
            </div>
          </div>
