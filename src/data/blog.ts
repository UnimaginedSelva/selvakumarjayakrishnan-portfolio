...
Three seats sit inside every one of these transitions, and [ASCEND](https://www.linkedin.com/feed/update/urn:li:activity:7464872957375516672/) speaks to all three.
...
That's the real signal for this seat in 2026. The old framing of a Business Sponsor's decision, build it yourself, buy a provider's capability, or run a BOT and transfer later, was always a bit too binary even when it was accurate. What Akkodis and Zinnov structured here is a sponsor decision that stages ownership deliberately, matching the structure to the risk and integration complexity of each specific piece of the business, rather than applying one deal shape to the whole transaction. [ASCEND](https://www.linkedin.com/feed/update/urn:li:activity:7464872957375516672/)'s early anchoring stage was always about defining the mandate and the ownership boundaries before execution starts. In 2026, that mandate increasingly needs to specify not just whether ownership transfers, but how, and on what schedule, and in what pieces.
