      ...
      <div className="max-w-5xl mx-auto px-6 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-bold text-slate-100 mb-3">
            Change Readiness Agent <span className="text-blue-400">(Gemini)</span>
          </h1>
        ...
        <div className="text-center mt-16 pt-8 border-t border-slate-800">
          <p className="text-slate-500 text-xs mb-3">
            ...
            <Link to="/change-readiness" className="text-gold-400 hover:text-gold-300 transition-colors">Try the original Change Readiness Agent</Link>.
          </p>
          <p className="text-slate-500 text-xs mb-3">
