    ...
    <div className="min-h-screen bg-slate-900 text-slate-100">
      ...
      <div className="max-w-5xl mx-auto px-6 py-12">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 bg-blue-500/10 border border-blue-500/30 text-blue-300 text-xs px-4 py-1.5 rounded-full mb-6 font-medium tracking-wide">
            AI AGENT · INTERVIEW PREPARATION · GEMINI
          </div>
          <h1 className="text-4xl font-bold text-slate-100 mb-3">
            Job Intelligence Agent <span className="text-blue-400">(Gemini)</span>
          </h1>
          ...
          <div className="space-y-6 animate-fade-in">
            ...
            <div className="text-center pt-4 border-t border-slate-800">
              <p className="text-slate-600 text-xs mb-2">
                ...
                <Link to="/job-intelligence" className="text-slate-500 hover:text-gold-400 transition-colors">Try the original Job Intelligence Agent</Link>.
              </p>
